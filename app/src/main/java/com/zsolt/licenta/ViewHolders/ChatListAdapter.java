...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListViewHolder> {
    ...
    public ChatListAdapter(List<Item> itemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ChatListViewHolder holder, int position) {
        ...
        } else if (item instanceof Trips) {
            Trips trip = (Trips) item;
            holder.getTextChatListName().setText(trip.getTitle());
        }
    }
